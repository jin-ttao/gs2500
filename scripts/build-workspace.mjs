...
for(const name of ['app.js','views.js','styles.css','integration.css','state.js','data.js','forecast.js','world-view.js','ledger-replay.js','clock.js'])await cp(path.join(root,'workspace',name),path.join(out,'workspace',name));
